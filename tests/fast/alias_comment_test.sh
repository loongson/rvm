...
rvm alias create default 3.0.1@test_gemset # status=0
ls -l $rvm_path/environments/default       # status=0; match=/3.0.1@test_gemset/
rvm alias list                             # match=/^default => ruby-3.0.1@test_gemset$/
rvm alias delete default                   # status=0
ls -l $rvm_path/environments/default       # status!=0

rvm alias create ruby-test-default 3.0.1@test_gemset # status=0
ls -l $rvm_path/environments/ruby-test-default       # status=0
rvm alias list                                       # match=/^ruby-test-default => ruby-3.0.1@test_gemset$/
...
rvm alias create veve 3.0.1       # status=0
ls -l $rvm_path/environments/veve # status=0; match=/3.0.1/
ls -l $rvm_path/wrappers/veve     # status=0; match=/3.0.1/
rvm alias list                    # match=/^veve => ruby-3.0.1$/
