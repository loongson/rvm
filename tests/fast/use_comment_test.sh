...
command rvm use 3.0.1   # status=0; match!=/Using /; env[GEM_HOME]!=/3.0.1/ ; match=/RVM is not a function/
rvm use 3.0.1           # status=0; match=/Using / ; env[GEM_HOME]=/3.0.1/
