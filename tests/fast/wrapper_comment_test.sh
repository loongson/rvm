...
rvm 3.0.1 do rvm wrapper $d/custom-script # status=0
wrapper_script=`rvm 3.0.1 do rvm wrapper show custom-script`
# status=0
# env[wrapper_script]=/.*/gems/ruby-3.0.1\/wrappers\/custom-script/
$wrapper_script
# status=0
# match=/.*/gems/ruby-3.0.1\Z/
