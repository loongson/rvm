...
rvm try_install 3.1.0
rvm try_install 3.0.5
rvm try_install 3.1.3

: separate default/current
rvm use 3.1.0@abc-test --create --default
# status=0
# match=/Using .*ruby-3.1.0 with gemset abc-test/
rvm current
# match=/ruby-3.1.0@abc-test/

rvm use 3.0.5@abc-test --create
# status=0
...
: default == current
rvm use 3.1.3@abc-test --create --default
# status=0
